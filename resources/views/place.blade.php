        ...
        <div class="container-fluid destination py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">{{ $region->region_name }}</h5>
                ...
                @foreach ($place as $p )
                    <h1 class="m-5">{{$p->place_name}}</h1>
                    <div>
                        <img class="img-fluid rounded w-100" src="{{asset($p->place_img)}}" alt="">
                    </div>
                    <p class="m-2 mb-10">{{$p->description}}</p>
                @endforeach
                </div>
            </div>
        </div>
